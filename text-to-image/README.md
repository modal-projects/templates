...
This template uses [Stable Diffusion 3.5 Large Turbo](https://huggingface.co/adamo1139/stable-diffusion-3.5-large-turbo-ungated), a diffusion model from Stability AI that generates images based on text prompts. Runs on an H100. Inference takes ~1 minute to cold start—largely from loading model weights to memory—and images are generated in ~1 second.
